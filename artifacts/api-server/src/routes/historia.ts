...
const HITOS_DEFAULT: HitoItem[] = [
  ...
  { year: "1908", title: "Comienzo de la Era Profesional", description: "River Plate inicia su camino en el fútbol profesional argentino, marcando el comienzo de una nueva etapa en la historia del club.", detail: "La camiseta con la banda roja diagonal se adopta en 1908, convirtiéndose en el símbolo distintivo que el club llevaría para siempre." },
  ...
  { year: "2026", title: "Leonardo Ponzio asume el interinato", description: "Tras la salida de Eduardo Coudet, River Plate confirmó el 27 de agosto de 2026 a Leonardo Ponzio como entrenador interino del plantel profesional.", detail: "El club comunicó oficialmente que Ponzio quedó al frente del equipo mientras la dirigencia define la continuidad del proyecto deportivo. Desde Israel, la Filial River Plate Israel Gaby \"Tucu\" Sajnin sigue cada partido con la misma pasión de siempre." },
];
