...
const HITOS_DEFAULT: HitoItem[] = [
  ...
  { year: "2026", title: "Eduardo Coudet, el nuevo ciclo", description: "Eduardo 'Chacho' Coudet asume como Director Técnico de River Plate, con la misión de continuar la grandeza del club.", detail: "Con amplia experiencia en el fútbol europeo y sudamericano, Coudet inició una nueva etapa para River. Desde Israel, la Filial River Plate Israel Gaby \"Tucu\" Sajnin sigue cada partido con la misma pasión de siempre.", imagenPortada: "/images/coudet.jpeg" },
];
