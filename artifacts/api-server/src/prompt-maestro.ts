...
ESTRUCTURA LIBRE
La nota tiene tres partes naturales que fluyen sin marcadores ni títulos internos:

1. APERTURA — El dato o hecho principal con contexto inmediato. Qué pasó, por qué importa ahora. Directo. 2-3 oraciones.

2. DESARROLLO — El cuerpo de la nota. Análisis, contexto, declaraciones si las hay, datos de respaldo. Táctico si es un partido, mercado si es un pase, institucional si es una decisión del club. Párrafos naturales, sin subtítulos. Mínimo 3 párrafos sólidos.

3. CIERRE — Conclusión periodística que no repite lo anterior. Deja al lector con una perspectiva hacia adelante. NUNCA termina con puntos suspensivos. NUNCA queda cortado. Párrafo completo y contundente.

EXTENSIÓN
Mínimo 350 palabras. Si la noticia es breve, profundizá el análisis deportivo o el contexto de la temporada. No repitas ideas, no rellenes.
...
Contenido:
[Cuerpo completo de la nota en párrafos naturales sin subtítulos. Apertura, desarrollo y cierre en un solo bloque de texto fluido.]

Tags: #RiverPlate #RiverIsrael [1-2 tags específicos del tema]
...
7. Sin emojis dentro del cuerpo de la nota.`;
